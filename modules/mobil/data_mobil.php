            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    if(mysqli_num_rows($query) == 0) {
                        echo '<tr><td colspan="6" class="text-center text-muted py-3">Belum ada data mobil. Silakan tambah data baru.</td></tr>';
                    }
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(!empty($row['foto']) && file_exists("../../assets/uploads/mobil/" . $row['foto'])): ?>
                                <img src="../../assets/uploads/mobil/<?= $row['foto']; ?>" class="img-thumbnail rounded" width="100" style="height: 60px; object-fit: cover;">
                            <?php else: ?>
                                <img src="https://via.placeholder.com/100x60?text=No+Image" class="img-thumbnail rounded">
                            <?php endif; ?>
                        </td>
                        <td class="fw-bold"><?= $row['nama_mobil']; ?></td>
                        <td>
                            <span class="badge bg-dark font-monospace"><?= $row['plat_nomor']; ?></span>
                        </td>
                        <td>
                            <?php 
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="edit_mobil.php?id=<?= $row['id_mobil']; ?>" class="btn btn-sm btn-outline-warning" title="Edit Data">
